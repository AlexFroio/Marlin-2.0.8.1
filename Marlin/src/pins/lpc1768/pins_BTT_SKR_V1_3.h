...
//
  ...
  #define X_MAX_PIN                        P1_26  // X+ Originally 1_28. Changed to match pinout of z-left-endstop on Y- port
#endif
  ...
  #define Z_MAX_PIN                        P1_28  // Z+ Originally 1_24. Changed to match pinout of z-left-endstop on Y- port
#endif
